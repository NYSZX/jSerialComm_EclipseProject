...
public final class SerialPort
{
	...
	static
	{
		...
		try
		{
			...
			InputStream fileContents = SerialPort.class.getResourceAsStream("/resources/" + libraryPath + "/" + fileName);
			if ((fileContents == null) && isAndroid)
			{
				libraryPath = libraryPath.replace("Android/", "lib/");
				fileContents = SerialPort.class.getResourceAsStream("/resources/" + libraryPath + "/" + fileName);
			}
